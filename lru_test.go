...
func Test_LruCacheSetAndGet(t *testing.T) {
	cache := New(&Config{
...
func Test_LruCacheSetWithExpire(t *testing.T) {
	cache := New(&Config{
		Capacity:       DEFAULT_CAPACITY,
		Expire:         NO_EXPIRE,
		EvictionPolicy: EVICTION_POLICY_LRU,
	})
...
func Test_LruCacheGetAll(t *testing.T) {
	cache := New(&Config{
		Capacity:       5,
		Expire:         NO_EXPIRE,
		EvictionPolicy: EVICTION_POLICY_LRU,
...
func Test_LruCacheDeleteExpired(t *testing.T) {
	cache := New(&Config{
		Capacity:       DEFAULT_CAPACITY,
		Expire:         NO_EXPIRE,
		EvictionPolicy: EVICTION_POLICY_LRU,
...
func Test_LruCacheSHeadNode(t *testing.T) {
	cache := New(&Config{
		Capacity:       5,
		Expire:         NO_EXPIRE,
		EvictionPolicy: EVICTION_POLICY_LRU,
...
func Test_LruCacheSTailNode(t *testing.T) {
	cache := New(&Config{
		Capacity:       5,
		Expire:         NO_EXPIRE,
		EvictionPolicy: EVICTION_POLICY_LRU,
...
func Benchmark_LruCacheSet(b *testing.B) {
	cache := New(&Config{
		Capacity:       DEFAULT_CAPACITY,
		Expire:         DEFAULT_EXPIRE,
		EvictionPolicy: EVICTION_POLICY_LRU,
...
func Benchmark_LruCacheGet(b *testing.B) {
	cache := New(&Config{
		Capacity:       DEFAULT_CAPACITY,
		Expire:         DEFAULT_EXPIRE,
		EvictionPolicy: EVICTION_POLICY_LRU,
